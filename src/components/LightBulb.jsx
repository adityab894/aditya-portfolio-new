      ...
      >
        ...
        <g className="toggle-scene__cords">
          ...
          <path
            ...
            strokeLinecap="square"
            strokeWidth="6"
            d="M123.228-28.59s28 8.131 28 19.506-18.667 13.005-28 19.507c-9.333 6.502-28 8.131-28 19.506s28 19.507 28 19.507-28 8.131-28 19.506 18.667 13.005 28 19.507c9.333 6.502 28 8.131 28 19.506s-28 19.507-28 19.507"
            transform="translate(-24.503 256.106)"
          />
          <path
            className="toggle-scene__cord"
            ...
            strokeLinecap="square"
            strokeWidth="6"
            d="M123.228-28.575s-20 16.871-20 28.468c0 11.597 13.333 18.978 20 28.468 6.667 9.489 20 16.87 20 28.467 0 11.597-20 28.468-20 28.468s20 16.871 20 28.468c0 11.597-13.333 18.978-20 28.468-6.667 9.489-20 16.87-20 28.467 0 11.597 20 28.468 20 28.468"
            transform="translate(-24.503 256.106)"
          />
          <path
            className="toggle-scene__cord"
            ...
            strokeLinecap="square"
            strokeWidth="6"
            d="M123.228-28.569s16 20.623 16 32.782c0 12.16-10.667 21.855-16 32.782-5.333 10.928-16 20.623-16 32.782 0 12.16 16 32.782 16 32.782s-16 20.623-16 32.782c0 12.16 10.667 21.855 16 32.782 5.333 10.928 16 20.623 16 32.782 0 12.16-16 32.782-16 32.782"
            transform="translate(-24.503 256.106)"
          />
          <path
            className="toggle-scene__cord"
            ...
            strokeLinecap="square"
            strokeWidth="6"
            d="M123.228-28.563s-10 24.647-10 37.623c0 12.977 6.667 25.082 10 37.623 3.333 12.541 10 24.647 10 37.623 0 12.977-10 37.623-10 37.623s10 24.647 10 37.623c0 12.977-6.667 25.082-10 37.623-3.333 12.541-10 24.647-10 37.623 0 12.977 10 37.623 10 37.623"
            transform="translate(-24.503 256.106)"
          />
